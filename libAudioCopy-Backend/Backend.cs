...
namespace libAudioCopy_Backend
{
    public class Backend
    {
        ...
        public static WebApplication Application => app;

        public static WebApplication PrepareApp(Action<Exception> ExceptionCaller, Action<Action> DispatcherCaller, string? uri = null)
        {
        ...
        {
            Console.WriteLine("AudioCopy.Backend should used with AudioCopy or AudioClone.");
